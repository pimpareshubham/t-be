...
router.post("/uploadProfilePicture", protectedRoute, upload.single('file'), async (req, res) => {
    try {
        ...
        res.json({ message: "Profile picture uploaded successfully", profileImg: user.profileImg });
    } catch (error) {
        console.error(error);
